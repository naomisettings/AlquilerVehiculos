...
public class Modelo {
  ...
  /**
   * Método que lee el archivo CSV con los datos de los clientes y lo carga 
  ...
  /**
   * Método estático que inicializa el singleton, llamando al constructor privado
   * @param cif
   * @param telefono
   * @param nombreEmpresa
   * @param direccion 
  ...
  /**
   * Añade un nuevo vehiculo a la colección y lo guarda en el archivo CSV correspondiente
   * @param vehiculo 
   */
  ...
  /**
   * Añade un nuevo alquiler a la colección y lo guarda en el archivo CSV correspondiente.
   * Además guarda el alquiler en el atributo ultimoAlquiler, para que sea accesible para
   * generar la factura
   * @param alquiler 
   */
